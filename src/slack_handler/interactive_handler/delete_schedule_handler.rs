...
use crate::{
    ...
    errors::AppError,
    slack_handler::interactive_handler::slack_request::{BlockAction, DeleteScheduleValue, InteractiveRequest},
};
...
pub async fn handle_delete_schedule(
    ...
    let scheduled_task = scheduled_tasks_db
        ...
        .await?;
    if request.user.id != scheduled_task.created_by_user_id {
